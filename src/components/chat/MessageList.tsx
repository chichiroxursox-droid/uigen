...
import { User, Bot, Loader2, Layers } from "lucide-react";
  ...
  if (messages.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-full px-4 text-center">
        <div className="flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-100 mb-6 shadow-sm">
          <Layers className="h-8 w-8 text-blue-600" />
        </div>
        <h2 className="text-2xl font-bold tracking-tight text-neutral-800 mb-3">
          Start a conversation
        </h2>
        <p className="text-neutral-500 text-base max-w-xs leading-relaxed">
          Describe the React component you want to create and watch it come to life
        </p>
      </div>
    );
  }
